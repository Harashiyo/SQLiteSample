...
/**
 * Created by Shohei on 2015/12/04.
 */
public class DaoItem {
    ...
    public static String create(){
        return "create table " + TABLE_NAME + "("+COLUMN_ID+" integer primary key autoincrement not null, " + COLUMN_NAME + " text not null" + COLUMN_PRICE + " integer not null" + ");";
    }
    ...
    public static long insert(Context context,DtoItem item){
        ...
        values.put(COLUMN_NAME, item.price);
